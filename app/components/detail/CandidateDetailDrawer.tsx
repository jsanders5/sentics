...
import { SocialPanel } from "@/app/components/detail/SocialPanel";
    ...
    <>
      ...
      >
        <div className="space-y-6 p-6">
          ...
          {/* Social & Sentiment (LunarCrush) — descriptive context + evidence */}
          <SocialPanel social={candidate.social} symbol={candidate.symbol} />
